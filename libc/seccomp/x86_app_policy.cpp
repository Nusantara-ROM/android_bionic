...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 56, 93, 92), //ioctl|fcntl
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 58, 92, 91), //setpgid
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 66, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 63, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 61, 89, 88), //umask
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 65, 88, 87), //dup2|getppid
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 68, 87, 86), //setsid|sigaction
...
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 76, 82, 81), //setrlimit
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 79, 81, 80), //getrusage|gettimeofday
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 90, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 86, 79, 78), //readlink
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 93, 78, 77), //mmap|munmap|truncate
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 102, 3, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 96, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 95, 75, 74), //fchmod
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 98, 74, 73), //getpriority|setpriority
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 114, 1, 0),
BPF_JUMP(BPF_JMP|BPF_JGE|BPF_K, 106, 72, 71), //socketcall|syslog|setitimer|getitimer
